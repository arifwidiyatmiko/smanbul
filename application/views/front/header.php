        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="index.html">Guru</a></li>
                <li><a href="index-form.html">Siswa</a></li>
                <li><a href="index-video.html">Sarana & Prasarana</a></li>
              </ul>
            </li>
            <li><a href="#facilities">Ekstrakulikuler</a></li>
            <li class="dropdown">
