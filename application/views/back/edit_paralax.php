<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Paralax</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
               <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url('Editor/paralax/update/'.$pages[0]->id);?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                      <label>Teks</label>
                                      <input type="text" name="link" class="form-control" value="<?php echo $pages[0]->link?>">
                                  </div>
                                  <div class="form-group">
