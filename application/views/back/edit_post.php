<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Judul Post : <?php echo $pages[0]->title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
               <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url('Editor/update/post/'.$pages[0]->id);?>" method="POST" enctype="multipart/form-data">
